...
tvis <- data.frame(
  ...
  content = c("Clarence Harmon becomes St. Louis' police commissioner, replacing Robert Scheetz",
              "Weed & Seed is launched as a federal crime prevention initiative <a onclick=customHref('about');>(Read More)</a>",
              "SLMPD begins gun buyback program <a onclick=customHref('about');>(Read More)</a>",
              ...
              "The St. Louis Consent-to-Search program begins <a onclick=customHref('about');>(Read More)</a>",
              "The Brady Hangun Violence Prevention Act passes <a onclick=customHref('about');>(Read More)</a>",
              ...
              "The Office of Juvenile Justice and Deliquency Prevention begins five year grant to establish the SafeFutures program (Read More)",
              "Ron Henderson becomes the new police commissioner, replacing Clarence Harmon",
              "The St. Louis community forms a Ceasefire Task Force <a onclick=customHref('about');>(Read More)</a>",
              ...
              "Strategic Approach to Community Safety Initiative (SACSI) Begins <a onclick=customHref('about');>(Read More)</a>",
              "Audrey G. Fleissig becomes US Attorney for the Eastern District of Missouri, replacing Edward Dowd",
              "The 5th District initiative increases police prescence in the 5th district, the highest-risk community <a onclick=customHref('about');>(Read More)</a>",
              ...
              "Project Safe Neighborhoods launched by federal government <a onclick=customHref('about');>(Read More)</a>",
              "Joe Mokwa becomes police comissioner, replacing Ron Henderson",
              "Hospital based trauma intervention program begins <a onclick=customHref('about');>(Read More)</a>",
              "Raymond Gruender becomes US Attorney for the Eastern District of Missouri, replacing Audrey Fleissig",
              "Most Violent Offenders Program launches, targeting high-risk individuals <a onclick=customHref('about');>(Read More)</a>",
              ...
              "Wells-Goodfellow Neighborhood initiative begins <a onclick=customHref('about');>(Read More)</a>",
